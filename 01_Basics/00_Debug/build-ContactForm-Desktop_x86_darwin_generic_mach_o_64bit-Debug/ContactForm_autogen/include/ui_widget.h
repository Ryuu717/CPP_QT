...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        firtNameLineEdit = new QLineEdit(Widget);
        firtNameLineEdit->setObjectName("firtNameLineEdit");

        horizontalLayout_2->addWidget(firtNameLineEdit);
