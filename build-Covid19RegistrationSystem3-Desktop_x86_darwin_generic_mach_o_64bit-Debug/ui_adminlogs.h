/********************************************************************************
** Form generated from reading UI file 'adminlogs.ui'
**
...
#ifndef UI_ADMINLOGS_H
#define UI_ADMINLOGS_H
...
public:
    ...
    void setupUi(QDialog *AdminLogs)
    {
        if (AdminLogs->objectName().isEmpty())
            AdminLogs->setObjectName("AdminLogs");
        AdminLogs->resize(771, 382);
        verticalLayout = new QVBoxLayout(AdminLogs);
        verticalLayout->setObjectName("verticalLayout");
        horizontalLayout_3 = new QHBoxLayout();
        horizontalLayout_3->setObjectName("horizontalLayout_3");
        pushButtonMyHealthAccount = new QPushButton(AdminLogs);
...
""));
        ...
        groupBox_6 = new QGroupBox(AdminLogs);
        ...
        pushButtonLogout = new QPushButton(AdminLogs);
        ...
        groupBox_2 = new QGroupBox(AdminLogs);
...
""));
        ...
        labelUserList = new QLabel(AdminLogs);
        ...
        tableView = new QTableView(AdminLogs);
        ...
        retranslateUi(AdminLogs);

        QMetaObject::connectSlotsByName(AdminLogs);
    } // setupUi

    void retranslateUi(QDialog *AdminLogs)
    {
        AdminLogs->setWindowTitle(QCoreApplication::translate("AdminLogs", "Dialog", nullptr));
        pushButtonMyHealthAccount->setText(QCoreApplication::translate("AdminLogs", "My health account ", nullptr));
        groupBox_6->setTitle(QString());
        labelAdmin->setText(QCoreApplication::translate("AdminLogs", "Icon", nullptr));
        label_17->setText(QCoreApplication::translate("AdminLogs", "Admin", nullptr));
        pushButtonLogout->setText(QCoreApplication::translate("AdminLogs", "Log out", nullptr));
        groupBox_2->setTitle(QString());
        pushButtonDashboard->setText(QCoreApplication::translate("AdminLogs", "1. Dashboard", nullptr));
        pushButtonUsers->setText(QCoreApplication::translate("AdminLogs", "2. Users", nullptr));
        pushButtonReports->setText(QCoreApplication::translate("AdminLogs", "3. Reports", nullptr));
        pushButtonLogs->setText(QCoreApplication::translate("AdminLogs", "4. Logs", nullptr));
        labelUserList->setText(QCoreApplication::translate("AdminLogs", "Logs", nullptr));
    } // retranslateUi

};

namespace Ui {
    class AdminLogs: public Ui_AdminLogs {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_ADMINLOGS_H
