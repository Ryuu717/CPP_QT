...
#include <memory>
#include "../Covid19RegistrationSystem3/userprofile.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_UserProfile_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_UserProfile_t qt_meta_stringdata_UserProfile = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_UserProfile[] = {
...
Q_CONSTINIT const QMetaObject UserProfile::staticMetaObject = { {
    ...
    qt_meta_stringdata_UserProfile.offsetsAndSizes,
    qt_meta_data_UserProfile,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_UserProfile_t,
        // Q_OBJECT / Q_GADGET
