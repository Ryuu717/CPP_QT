...
#include <memory>
#include "../Covid19RegistrationSystem3/userpage.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_UserPage_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_UserPage_t qt_meta_stringdata_UserPage = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_UserPage[] = {
...
Q_CONSTINIT const QMetaObject UserPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_UserPage.offsetsAndSizes,
    qt_meta_data_UserPage,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_UserPage_t,
        // Q_OBJECT / Q_GADGET
