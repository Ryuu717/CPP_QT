...
public:
    ...
    void setupUi(QDialog *AdminLogs)
    {
        ...
        AdminLogs->setStyleSheet(QString::fromUtf8("background-color: rgb(104, 161, 229);"));
        layoutWidget = new QWidget(AdminLogs);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(12, 73, 751, 291));
...
"background-color: rgb(104, 161, 229);"));
        ...
        layoutWidget_2 = new QWidget(AdminLogs);
        layoutWidget_2->setObjectName("layoutWidget_2");
        layoutWidget_2->setGeometry(QRect(10, 10, 741, 61));
